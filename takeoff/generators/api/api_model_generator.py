...
class ApiModelGenerator(ApiBaseGenerator):
    ...
    def run(self):
        print(f"Running Api Model Generator: {self.name} : {self.model_name}")
    ...
    def write_model_file(self):
        ...
        destination_folder = f"{self.project_folder()}/api/models"
    ...
    def update_models_file(self):
        current_file = f"{self.project_folder()}/api/models/__init__.py"
    ...
    def register_admin(self):
        current_file = f"{self.project_folder()}/api/admin.py"
